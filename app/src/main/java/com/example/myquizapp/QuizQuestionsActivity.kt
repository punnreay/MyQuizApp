...
//        defanltOptionsView()
    ...
    private fun defanltOptionsView() {
    ...
    private fun answerView(answer: Int, drawavleView: Int) {
        when (answer) {
            1 -> {
                tvOptionOne?.background = ContextCompat.getDrawable(this, drawavleView)
            }
            2 -> {
                tvOptionTwo?.background =
                    ContextCompat.getDrawable(this@QuizQuestionsActivity, drawavleView)
            }
            3 -> {
